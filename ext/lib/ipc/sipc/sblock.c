...
//这里分配共享内存 在NuttX里面sblock的共享内存怎么来确定
	...
	ipc_debug( "smem_addr 0x%x record_share_addr 0x%x",sblock->smem_addr,record_share_addr);
